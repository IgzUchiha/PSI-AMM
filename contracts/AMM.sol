...
contract AMM {
    ...
    // If first time adding liquidity , make sure share is 1000
    if(totalShares == 0) {
        share = 1000 * PRECISION;
    } else {
    ...
    //Returns amount of Token2 recieved when swapping token 1
    ...
    returns(uint256 token2Amount) 
    {
     ...
     //Returns amount of Token1 recieved when swapping token 2
